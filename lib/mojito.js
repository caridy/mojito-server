...
mojito.dispatch = function (name, options) {
    ...
    var callback = function (req, res, next) {
        ...
        // augmenting runtime with more info
        runtime.dispatched = [engine, options];
        runtime['dispatch engine'] = mojito.app.set('dispatch engine');
        runtime['dispatchers']     = Object.keys(mojito.dispatchers);
...
mojito.config = function (config) {
    var locals = mojito.locals;

    if (!locals) {
        throw new Error('mojito() should happens first.');
    }
